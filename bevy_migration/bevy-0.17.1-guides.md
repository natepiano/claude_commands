# Bevy 0.17.1 Migration Guides

This file contains all official Bevy 0.17.1 migration guides combined into a single document.

**Source:** https://github.com/bevyengine/bevy/tree/v0.17.1/release-content/migration-guides
**Total Guides:** 114
**Generated:** 2025-10-03 18:27:51 UTC

---

# Table of Contents - Subagent Distribution

The 114 migration guides are distributed across 10 subagents for parallel analysis:

## Subagent 1

163 - migration guide 1 - `LightVisibilityClass` renamed to `ClusterVisibilityClass`
178 - migration guide 2 - Make `ScrollPosition` newtype `Vec2`
191 - migration guide 3 - RenderTargetInfo's default `scale_factor` has been changed to `1.`
204 - migration guide 4 - `ScrollPosition` now uses logical pixel units and is no longer overwritten during layout updates
216 - migration guide 5 - `Anchor` is now a required component on `Sprite`
244 - migration guide 6 - `AnimationGraph` no longer supports raw AssetIds
271 - migration guide 7 - `Assets::insert` and `Assets::get_or_insert_with` now return `Result`
287 - migration guide 8 - `bevy_render` reorganization
339 - migration guide 9 - `CheckChangeTicks` parameter in `System::check_change_tick`
371 - migration guide 10 - ChromaticAberration LUT is now Option
386 - migration guide 11 - `CloneBehavior` is no longer `PartialEq` or `Eq`
414 - migration guide 12 - Combine now takes an extra parameter

## Subagent 2

427 - migration guide 13 - Component lifecycle reorganization
448 - migration guide 14 - `Entry` enum is now `ComponentEntry`
463 - migration guide 15 - `ComponentsRegistrator` no longer implements `DerefMut`
476 - migration guide 16 - Composable Specialization
709 - migration guide 17 - Compressed image saver feature
722 - migration guide 18 - Move cursor-related types from `bevy_winit` to `bevy_window`
742 - migration guide 19 - Deprecate `iter_entities` and `iter_entities_mut`.
758 - migration guide 20 - `DragEnter` now includes the dragged entity
773 - migration guide 21 - `DynamicBundle`
833 - migration guide 22 - `Entities` API changes
857 - migration guide 23 - EntityClonerBuilder Split
944 - migration guide 24 - Manual Entity Creation and Representation

## Subagent 3

1033 - migration guide 25 - `Event` trait split / Rename
1046 - migration guide 26 - Extract `PickingPlugin` members into `PickingSettings`
1063 - migration guide 27 - Extract `PointerInputPlugin` members into `PointerInputSettings`
1080 - migration guide 28 - `take_extract` now returns `dyn FnMut` instead of `dyn Fn`
1097 - migration guide 29 - Extract UI text colors per glyph
1113 - migration guide 30 - `ExtractedUiNode`'s `stack_index` has been renamed to `z_order` and is now an `f32`.
1133 - migration guide 31 - `FULLSCREEN_SHADER_HANDLE` replaced with `FullscreenShader`
1208 - migration guide 32 - `GatedReader` and `GatedOpener` are now private.
1225 - migration guide 33 - Generic `Option` Parameter
1260 - migration guide 34 - Updated `glam`, `rand` and `getrandom` versions with new failures when building for web
1308 - migration guide 35 - OpenGL ES `wgpu` backend is no longer supported by default
1324 - migration guide 36 - glTF animation loading is now optional

## Subagent 4

1337 - migration guide 37 - `Handle::Weak` has been replaced by `Handle::Uuid`.
1384 - migration guide 38 - Split `Hdr` from `Camera`
1402 - migration guide 39 - Improve error when using `run_system` command with a `SystemId` of wrong type
1416 - migration guide 40 - Observers and one-shot systems are now marked as `Internal`
1433 - migration guide 41 - Interned labels and `DynEq`
1448 - migration guide 42 - `labeled_asset_scope` can now return errors
1486 - migration guide 43 - Change filters container of `LogDiagnosticsState` to `HashSet`
1501 - migration guide 44 - Reflection-based maps are now unordered
1519 - migration guide 45 - Unify `ObserverState` and `Observer` components
1543 - migration guide 46 - Smooth normals implementation changed
1597 - migration guide 47 - Non-generic `Access`
1621 - migration guide 48 - Observer / Event API Changes

## Subagent 5

1770 - migration guide 49 - Exclusive systems may not be used as observers
1785 - migration guide 50 - `OverflowClipBox`'s default is now `PaddingBox`
1799 - migration guide 51 - Changes to Bevy's system parallelism strategy
1836 - migration guide 52 - Changes to the default error handler mechanism
1857 - migration guide 53 - `Location` is no longer a `Component`
1870 - migration guide 54 - Original target of `Pointer` picking events is now stored on observers
1907 - migration guide 55 - Polylines and Polygons are no longer const-generic
1925 - migration guide 56 - Query items can borrow from query state
1998 - migration guide 57 - `ViewRangefinder3d::from_world_from_view` now takes `Affine3A` instead of `Mat4`
2011 - migration guide 58 - `ReflectAsset` now uses `UntypedAssetId` instead of `UntypedHandle`
2043 - migration guide 59 - Changes to type registration for reflection

## Subagent 6

2077 - migration guide 60 - Relationship method set_risky
2125 - migration guide 61 - `RelativeCursorPosition` is now object-centered
2138 - migration guide 62 - Remove `ArchetypeComponentId`
2167 - migration guide 63 - Remove `Bundle::register_required_components`
2180 - migration guide 64 - Removed `cosmic_text` re-exports
2205 - migration guide 65 - Remove default implementation of `extend_from_iter` from `RelationshipSourceCollection`
2239 - migration guide 66 - Removed Deprecated Batch Spawning Methods
2268 - migration guide 67 - Remove `scale_value`
2281 - migration guide 68 - Replaced `TextFont` constructor methods with `From` impls
2304 - migration guide 69 - Remove the `Add`/`Sub` impls on `Volume`
2336 - migration guide 70 - `RemovedComponents` methods renamed to match `Event` to `Message` rename

## Subagent 7

2359 - migration guide 71 - Renamed `JustifyText` to `Justify`
2374 - migration guide 72 - Renamed `Condition` to `SystemCondition`
2389 - migration guide 73 - Rename `Pointer<Pressed>` and `Pointer<Released>` to `Pointer<Press>` and `Pointer<Release>`
2402 - migration guide 74 - Use glTF material names for spawned primitive entities
2420 - migration guide 75 - Renamed state scoped entities and events
2447 - migration guide 76 - Renamed `Timer::paused` to `Timer::is_paused` and `Timer::finished` to `Timer::is_finished`
2465 - migration guide 77 - Transform and GlobalTransform::compute_matrix rename
2479 - migration guide 78 - Renamed BRP methods
2513 - migration guide 79 - Renamed `ComputedNodeTarget` and `update_ui_context_system`
2528 - migration guide 80 - `RenderGraphApp` renamed to `RenderGraphExt`
2542 - migration guide 81 - Many render resources now initialized in `RenderStartup`

## Subagent 8

2695 - migration guide 82 - RenderTarget error handling
2713 - migration guide 83 - Replace `Gilrs`, `AccessKitAdapters`, and `WinitWindows` non-send resources
2788 - migration guide 84 - Required components refactor
2810 - migration guide 85 - Rework `MergeMeshError`
2827 - migration guide 86 - Fix `From<Rot2>` implementation for `Mat2`
2859 - migration guide 87 - `VectorSpace` implementations
2874 - migration guide 88 - `SceneSpawner` methods have been renamed and replaced
2893 - migration guide 89 - Schedule API Cleanup
2951 - migration guide 90 - Rename `send_event` and similar methods to `write_message`
2982 - migration guide 91 - Separate Border Colors
2995 - migration guide 92 - Deprecated Simple Executor

## Subagent 9

3027 - migration guide 93 - `SpawnableList`
3103 - migration guide 94 - Specialized UI transform
3144 - migration guide 95 - Window is now split into multiple components
3195 - migration guide 96 - The render target info from `ComputedUiTargetCamera` has been removed.
3208 - migration guide 97 - Fixed UI draw order and `stack_z_offsets` changes
3249 - migration guide 98 - State-scoped entities are now always enabled implicitly
3265 - migration guide 99 - Stop exposing mp3 support through minimp3
3287 - migration guide 100 - Stop storing access in systems
3340 - migration guide 101 - `SyncCell` and `SyncUnsafeCell` moved to bevy_platform
3354 - migration guide 102 - `System::run` returns `Result`
3427 - migration guide 103 - Consistent `*Systems` naming convention for system sets

## Subagent 10

3470 - migration guide 104 - TAA is no longer experimental
3489 - migration guide 105 - `Text2d` moved to `bevy_sprite`
3503 - migration guide 106 - `TextShadow` has been moved to `bevy::ui::widget::text`
3516 - migration guide 107 - TextureFormat::pixel_size now returns a Result
3533 - migration guide 108 - Move UI Debug Options from `bevy_ui` to `bevy_ui_render`
3560 - migration guide 109 - Unified system state flag
3610 - migration guide 110 - view_transformations.wgsl deprecated in favor of view.wgsl
3645 - migration guide 111 - Enable Wayland by default
3690 - migration guide 112 - `wgpu` 25
3738 - migration guide 113 - Window Resolution Constructors
3766 - migration guide 114 - New `zstd` backend
...
<!-- ================================================================ -->
<!-- Migration Guide: LightVisibilityClass_rename.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: Newtype_ScrollPosition.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: RenderTargetInfo_default.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: UI_scroll_position_is_now_logical.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: anchor_is_removed_from_sprite.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: animation_graph_no_more_asset_ids.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: assets-insert-result.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: bevy_render_reorganization.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: check_change_ticks.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: chromatic_aberration_option.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: clone_behavior_no_longer_eq.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: combine_soundness_fix.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: component-lifecycle-module.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: component_entry.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: components-registrator-derefmut.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: composable_specialization.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: compressed-image-saver.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: cursor-android.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: deprecate_iter_entities.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: dragenter_includes_dragged_entity.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: dynamic-bundle-movingptr.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: entities_apis.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: entity_cloner_builder_split.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: entity_representation.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: event_split.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: extract-picking-plugin-members.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: extract-pointer-input-plugin-members.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: extract_fn_is_mut.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: extract_ui_text_colors_per_glyph.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: extracted_uinodes_z_order.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: fullscreen_shader_resource.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: gated_reader.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: generic-option-parameter.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: glam-rand-upgrades.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: gles_optional.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: gltf-animation-load-optional.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: handle_weak_replaced_with_handle_uuid.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: hdr_component.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: incorrect-type-error-on-run-system-command.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: internal_entities.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: interned-labels-cleanup.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: labeled_asset_scope_errors.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: log-diagnostics-hash-set.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: map_set_apply.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: merge_observerState_observer_single_component.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: mesh_compute_smooth_normals.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: non-generic-access.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: observer_and_event_changes.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: observers_may_not_be_exclusive.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: overflowclipbox_default_is_now_paddingbox.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: parallelism_strategy_changes.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: per-world-error-handler.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: picking_location_not_component.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: pointer_target.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: primitives_non_const_generic_meshable.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: query_items_borrow_from_query_state.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: rangefinder.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: reflect_asset_asset_ids.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: reflect_registration_changes.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: relationship_set_risky.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: relative_cursor_position_is_object_centered.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: remove_archetype_component_id.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: remove_bundle_register_required_components.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: remove_cosmic_text_reexports.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: remove_default_extend_from_iter.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: remove_deprecated_batch_spawning.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: remove_scale_value.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: remove_text_font_from_constructor_methods.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: remove_the_add_sub_impls_on_volume.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: removed_components_stores_messages.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: rename-justifytext.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: rename_condition.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: rename_pointer_events.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: rename_spawn_gltf_material_name.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: rename_state_scoped.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: rename_timer_paused_and_finished.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: rename_transform_compute_matrix.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: renamed_BRP_methods.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: renamed_computednodetarget.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: render_graph_app_to_ext.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: render_startup.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: render_target_info_error.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: replace_non_send_resources.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: required_components_rework.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: rework_merge_mesh_error.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: rot2_matrix_construction.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: scalar-field-on-vector-space.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: scene_spawner_api.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: schedule_cleanup.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: send_event_rename.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: separate-border-colors.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: simple_executor_going_away.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: spawnable-list-movingptr.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: specialized_ui_transform.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: split-window.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: split_up_computeduitargetcamera.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: stack_z_offsets_changes.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: state_scoped_entities_by_default.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: stop-exposing-minimp3.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: stop_storing_system_access.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: sync_cell_utils.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: system_run_returns_result.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: system_set_naming_convention.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: taa_non_experimental.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: text2d_moved_to_bevy_sprite.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: textshadow_is_moved_to_widget_text_module.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: texture_format_pixel_size_returns_result.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: ui-debug-overlay.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: unified_system_state_flag.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: view-transformations.md -->
<!-- ================================================================ -->
...
<!-- ================================================================ -->
<!-- Migration Guide: window_resolution_constructors.md -->
<!-- ================================================================ -->
